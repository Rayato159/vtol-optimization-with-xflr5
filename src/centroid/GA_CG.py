    ...
    def getPopulation(self):
        ...
        for _ in range(self.population_num):
            while True:
                ...
                print(rand_param)
                if(
                    rand_param[0] < rand_param[1] and rand_param[0] > 0 and rand_param[1] > 0 and rand_param[2] < 0
                    and -0.1 <= self.decode(rand_chromosome)[1] <= 0.1
                ):
                    break
        ...
        for gen in range(self.generation):
            ...
            for _ in range(int(self.population_num/2)):
                ...
                while True:
                    ...
                    if(
                        decode_1[0] < decode_1[1] 
                        and decode_1[0] > 0 
                        and decode_1[1] > 0 
                        and decode_1[2] < 0
                        and decode_2[0] < decode_2[1] 
                        and decode_1[0] > 0 
                        and decode_2[1] > 0 
                        and decode_2[2] < 0
                        and -0.1 <= self.decode(mutated_childs[0])[1] <= 0.1
                        and -0.1 <= self.decode(mutated_childs[1])[1] <= 0.1
                    ):
                        break
